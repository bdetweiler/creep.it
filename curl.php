...
class Curl
{
    ...
    public $referer = '';
    public $user_agent = 'Mozilla/5.0 (X11; U; Linux i686; en-US; rv:1.8.1.1) Gecko/20061205 Iceweasel/2.0.0.1 (Debian-2.0.0.1+dfsg-2)';
    ...
    protected function request($method, $url, $vars = array())
    {
        ...
        curl_setopt($this->handle, CURLOPT_FRESH_CONNECT, 1);
